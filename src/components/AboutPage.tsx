    ...
    >
      ...
      <div className="max-w-3xl w-full mx-auto relative">
        ...
        <div className="bg-gray-800 p-6 md:p-8 rounded-lg shadow-lg border border-gray-700">
          ...
          Perkenalkan, saya Tsaqif, pelajar yang lagi asyik belajar jadi developer. Saya senang utak-atik kode, ngebangun aplikasi, dan belajar hal baru dari error-error yang kadang muncul tiba-tiba.
            <br/><br/>
            Selain ngoding, Saya juga suka main PUBG dan catur. Dua-duanya bantu jaga fokus dan bikin otak tetap jalan. Info mabar? jawa jawa jawa 😄
            <br/><br/>
          </p>
        </div>
